...
# Usage: fm-harness.sh                  print own harness: claude|codex|opencode|pi|pi-signed|grok|kimi|qwen|unknown
...
detect_own() {
  ...
  # Only claude, pi, and grok have verified markers consulted here; codex,
  # opencode, kimi, and qwen are resolved by ancestry instead, so a foreign
