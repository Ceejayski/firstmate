...
[ -z "${FM_PR_PROVIDER+x}" ] && FM_PR_PROVIDER=
[ -z "${FM_PR_URL+x}" ] && FM_PR_URL=
[ -z "${FM_PR_HOST+x}" ] && FM_PR_HOST=
[ -z "${FM_PR_PATH+x}" ] && FM_PR_PATH=
[ -z "${FM_PR_OWNER+x}" ] && FM_PR_OWNER=
[ -z "${FM_PR_REPO+x}" ] && FM_PR_REPO=
[ -z "${FM_PR_NUMBER+x}" ] && FM_PR_NUMBER=
[ -z "${FM_PR_DATA_PROVIDER+x}" ] && FM_PR_DATA_PROVIDER=
[ -z "${FM_PR_DATA_URL+x}" ] && FM_PR_DATA_URL=
[ -z "${FM_PR_DATA_HOST+x}" ] && FM_PR_DATA_HOST=
[ -z "${FM_PR_DATA_PATH+x}" ] && FM_PR_DATA_PATH=
[ -z "${FM_PR_DATA_NUMBER+x}" ] && FM_PR_DATA_NUMBER=
[ -z "${FM_PR_META_PROVIDER+x}" ] && FM_PR_META_PROVIDER=
[ -z "${FM_PR_META_URL+x}" ] && FM_PR_META_URL=
[ -z "${FM_PR_META_HOST+x}" ] && FM_PR_META_HOST=
[ -z "${FM_PR_META_PATH+x}" ] && FM_PR_META_PATH=
[ -z "${FM_PR_META_NUMBER+x}" ] && FM_PR_META_NUMBER=
[ -z "${FM_PR_REG_ID+x}" ] && FM_PR_REG_ID=
[ -z "${FM_PR_REG_PROVIDER+x}" ] && FM_PR_REG_PROVIDER=
[ -z "${FM_PR_REG_URL+x}" ] && FM_PR_REG_URL=
[ -z "${FM_PR_REG_HOST+x}" ] && FM_PR_REG_HOST=
[ -z "${FM_PR_REG_PATH+x}" ] && FM_PR_REG_PATH=
[ -z "${FM_PR_REG_NUMBER+x}" ] && FM_PR_REG_NUMBER=
[ -z "${FM_PR_REG_DATA_HASH+x}" ] && FM_PR_REG_DATA_HASH=
[ -z "${FM_PR_REG_TEMPLATE_HASH+x}" ] && FM_PR_REG_TEMPLATE_HASH=
[ -z "${FM_PR_REG_DATA_IDENTITY+x}" ] && FM_PR_REG_DATA_IDENTITY=
[ -z "${FM_PR_REG_CHECK_IDENTITY+x}" ] && FM_PR_REG_CHECK_IDENTITY=
[ -z "${FM_PR_POLL_DATA_TMP+x}" ] && FM_PR_POLL_DATA_TMP=
[ -z "${FM_PR_POLL_CHECK_TMP+x}" ] && FM_PR_POLL_CHECK_TMP=
[ -z "${FM_PR_POLL_REG_TMP+x}" ] && FM_PR_POLL_REG_TMP=
[ -z "${FM_PR_POLL_DATA_DEST+x}" ] && FM_PR_POLL_DATA_DEST=
[ -z "${FM_PR_POLL_CHECK_DEST+x}" ] && FM_PR_POLL_CHECK_DEST=
[ -z "${FM_PR_POLL_REG_DEST+x}" ] && FM_PR_POLL_REG_DEST=
[ -z "${FM_PR_POLL_EXPECT_ID+x}" ] && FM_PR_POLL_EXPECT_ID=
[ -z "${FM_PR_POLL_EXPECT_PROVIDER+x}" ] && FM_PR_POLL_EXPECT_PROVIDER=
[ -z "${FM_PR_POLL_EXPECT_URL+x}" ] && FM_PR_POLL_EXPECT_URL=
[ -z "${FM_PR_POLL_EXPECT_HOST+x}" ] && FM_PR_POLL_EXPECT_HOST=
[ -z "${FM_PR_POLL_EXPECT_PATH+x}" ] && FM_PR_POLL_EXPECT_PATH=
[ -z "${FM_PR_POLL_EXPECT_NUMBER+x}" ] && FM_PR_POLL_EXPECT_NUMBER=
[ -z "${FM_PR_POLL_EXPECT_DATA_HASH+x}" ] && FM_PR_POLL_EXPECT_DATA_HASH=
[ -z "${FM_PR_POLL_EXPECT_TEMPLATE_HASH+x}" ] && FM_PR_POLL_EXPECT_TEMPLATE_HASH=
[ -z "${FM_PR_POLL_EXPECT_DATA_IDENTITY+x}" ] && FM_PR_POLL_EXPECT_DATA_IDENTITY=
[ -z "${FM_PR_POLL_EXPECT_CHECK_IDENTITY+x}" ] && FM_PR_POLL_EXPECT_CHECK_IDENTITY=
[ -z "${FM_PR_POLL_TEMPLATE+x}" ] && FM_PR_POLL_TEMPLATE=
[ -z "${FM_PR_POLL_STATE_DEVICE+x}" ] && FM_PR_POLL_STATE_DEVICE=
[ -z "${FM_PR_POLL_SNAPSHOT_ID+x}" ] && FM_PR_POLL_SNAPSHOT_ID=
[ -z "${FM_PR_POLL_SNAPSHOT_PROVIDER+x}" ] && FM_PR_POLL_SNAPSHOT_PROVIDER=
[ -z "${FM_PR_POLL_SNAPSHOT_URL+x}" ] && FM_PR_POLL_SNAPSHOT_URL=
[ -z "${FM_PR_POLL_SNAPSHOT_HOST+x}" ] && FM_PR_POLL_SNAPSHOT_HOST=
[ -z "${FM_PR_POLL_SNAPSHOT_PATH+x}" ] && FM_PR_POLL_SNAPSHOT_PATH=
[ -z "${FM_PR_POLL_SNAPSHOT_NUMBER+x}" ] && FM_PR_POLL_SNAPSHOT_NUMBER=
[ -z "${FM_PR_POLL_SNAPSHOT_DATA_HASH+x}" ] && FM_PR_POLL_SNAPSHOT_DATA_HASH=
[ -z "${FM_PR_POLL_SNAPSHOT_TEMPLATE_HASH+x}" ] && FM_PR_POLL_SNAPSHOT_TEMPLATE_HASH=
[ -z "${FM_PR_POLL_SNAPSHOT_DATA_IDENTITY+x}" ] && FM_PR_POLL_SNAPSHOT_DATA_IDENTITY=
[ -z "${FM_PR_POLL_SNAPSHOT_CHECK_IDENTITY+x}" ] && FM_PR_POLL_SNAPSHOT_CHECK_IDENTITY=
[ -z "${FM_PR_POLL_SNAPSHOT_REG_HASH+x}" ] && FM_PR_POLL_SNAPSHOT_REG_HASH=
[ -z "${FM_PR_POLL_SNAPSHOT_REG_IDENTITY+x}" ] && FM_PR_POLL_SNAPSHOT_REG_IDENTITY=
[ -z "${FM_PR_RETIRE_ID+x}" ] && FM_PR_RETIRE_ID=
[ -z "${FM_PR_RETIRE_PROVIDER+x}" ] && FM_PR_RETIRE_PROVIDER=
[ -z "${FM_PR_RETIRE_URL+x}" ] && FM_PR_RETIRE_URL=
[ -z "${FM_PR_RETIRE_HOST+x}" ] && FM_PR_RETIRE_HOST=
[ -z "${FM_PR_RETIRE_PATH+x}" ] && FM_PR_RETIRE_PATH=
[ -z "${FM_PR_RETIRE_NUMBER+x}" ] && FM_PR_RETIRE_NUMBER=
[ -z "${FM_PR_RETIRE_DATA_HASH+x}" ] && FM_PR_RETIRE_DATA_HASH=
[ -z "${FM_PR_RETIRE_TEMPLATE_HASH+x}" ] && FM_PR_RETIRE_TEMPLATE_HASH=
[ -z "${FM_PR_RETIRE_DATA_IDENTITY+x}" ] && FM_PR_RETIRE_DATA_IDENTITY=
[ -z "${FM_PR_RETIRE_CHECK_IDENTITY+x}" ] && FM_PR_RETIRE_CHECK_IDENTITY=
[ -z "${FM_PR_RETIRE_REG_HASH+x}" ] && FM_PR_RETIRE_REG_HASH=
[ -z "${FM_PR_RETIRE_REG_IDENTITY+x}" ] && FM_PR_RETIRE_REG_IDENTITY=
[ -z "${FM_PR_RETIRE_RECEIPT_HASH+x}" ] && FM_PR_RETIRE_RECEIPT_HASH=
[ -z "${FM_PR_RETIRE_RECEIPT_IDENTITY+x}" ] && FM_PR_RETIRE_RECEIPT_IDENTITY=
[ -z "${FM_PR_POLL_RETIREMENT_REJECTED+x}" ] && FM_PR_POLL_RETIREMENT_REJECTED=
