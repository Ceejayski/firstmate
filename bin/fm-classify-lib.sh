...
FM_CLASSIFY_CAPTAIN_RE_DEFAULT='done:|needs-decision:|blocked:|failed:|ready-for-review:|ready-for-merge:|verdict:|returned:|PR ready|checks green|ready in branch|merged'
