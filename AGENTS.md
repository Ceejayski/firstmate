...
- `context-pack` - load before every crewmate or scout dispatch and whenever expanding a brief's task context.
- `context-graph-curate` - load after a scout or design report lands or `/stow` files a durable cross-task link.
